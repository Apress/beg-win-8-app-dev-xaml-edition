...
using UpdateTiles.UpdateTiles_XamlTypeInfo;
...
namespace UpdateTiles.UpdateTiles_XamlTypeInfo
{
    ...
    internal partial class XamlTypeInfoProvider
    {
        ...
        private object Activate_0_MainPage() { return new UpdateTiles.MainPage(); }
        ...
        private IXamlType CreateXamlType(string typeName)
        {
            ...
            case "UpdateTiles.MainPage":
                userType = new XamlUserType(this, typeName, typeof(UpdateTiles.MainPage), GetXamlTypeByName("Windows.UI.Xaml.Controls.Page"));
