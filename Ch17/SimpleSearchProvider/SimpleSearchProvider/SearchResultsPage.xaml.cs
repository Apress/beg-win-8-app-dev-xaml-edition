...
using System.IO;
using System.Linq;
using SimpleSearchProvider.NetflixCatalogService;
...
namespace SimpleSearchProvider
{
    ...
    /// </summary>
    public sealed partial class SearchResultsPage : SimpleSearchProvider.Common.LayoutAwarePage
    {
        private static readonly Uri NetflixServiceUri = new Uri("http://odata.netflix.com/v2/Catalog");
        ...
        private void OnShareDataRequested(DataTransferManager sender, DataRequestedEventArgs e)
        {
            ...
            package.SetText(string.Format("Search for \"{0}\" yielded {1} result(s)", queryText, resultsGridView.Items.Count));
        ...
        void Filter_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            if (selectedFilter != null)
            {
                ...
                if (!String.IsNullOrEmpty(searchText))
                {
                    ...
                    queryResults.LoadCompleted += (o, args) =>
                        {
        ...
        /// </summary>
        private sealed class Filter : SimpleSearchProvider.Common.BindableBase
        {
